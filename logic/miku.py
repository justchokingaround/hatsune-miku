...
@bot.slash_command(description="displays image", guild_ids=[GUILD_ID])
...
@bot.slash_command(description="displays random image", guild_ids=[GUILD_ID])
...
@bot.slash_command(description="who is hatsune miku?", guild_ids=[GUILD_ID])
...
@bot.slash_command(description="facts about hatsune miku", guild_ids=[GUILD_ID])
...
@bot.slash_command(description="hatsune miku profile", guild_ids=[GUILD_ID])
